...
class MigrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create migration" do
    assert_difference('Migration.count') do
      post migrations_url, params: { migration: { name: @migration.name, value: @migration.value } }
    end
  ...
  test "should update migration" do
    patch migration_url(@migration), params: { migration: { name: @migration.name, value: @migration.value } }
